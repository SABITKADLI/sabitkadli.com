...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>CRM Development</span> <span className="text-primary/60">✦</span>
    <span>Data Migration</span> <span className="text-secondary/60">✦</span>
    <span>API Integration</span> <span className="text-primary/60">✦</span>
    <span>Cloud Architecture</span> <span className="text-secondary/60">✦</span>
    <span>Business Analysis</span> <span className="text-primary/60">✦</span>
    <span>Digital Transformation</span> <span className="text-secondary/60">✦</span>
    <span>Systems Integration</span> <span className="text-primary/60">✦</span>
    <span>RPA & Automation</span> <span className="text-secondary/60">✦</span>
  </div>
);
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                ...
                <MagneticButton
                  as="a"
                  href="https://github.com/sabitkadli"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground"
                >
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © 2025 Sabit Kadli. All rights reserved.
            </div>
